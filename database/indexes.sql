...
CREATE INDEX IF NOT EXISTS idx_slow_events_source_occurred ON slow_events(source, occurred_at);
CREATE INDEX IF NOT EXISTS idx_slow_events_desc ON slow_events(description_id);
CREATE INDEX IF NOT EXISTS idx_slow_events_desc_time ON slow_events(description_id, occurred_at);
